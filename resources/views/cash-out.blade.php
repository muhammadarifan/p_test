    ...
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            @if (Auth::user()->role->name == 'BAPAK')
                <a href="{{route('cash-out.add')}}"><x-button>Tambah Pengeluaran</x-button></a>
            @endif
        </div>
    </x-slot>
                            ...
                            <div class="flex flex-col items-end">
                                ...
                                <div class="flex items-end mt-5">
                                    @if (!$transaction->confirmed)
                                        <div class="ml-4 text-sm leading-5 text-gray-900">
                                            <a href="{{route('cash-out.edit', $transaction->id)}}"><x-button>Ubah</x-button></a>
                                        </div>
                                        <div class="ml-4 text-sm leading-5 text-gray-900">
                                            <a href="{{route('cash-out.delete', $transaction->id)}}"><x-button>Hapus</x-button></a>
                                        </div>
                                    @endif
